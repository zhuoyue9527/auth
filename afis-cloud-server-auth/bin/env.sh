...
export MAIN_SERVER_OBJECT=com.afis.cloud.AfisCloudServerApplication
export MAIN_SERVRt_OPTS=" -d64 -server -Xms256M -Xmx512M "
export HFP_SERVER_HOME=/home/jssb/afis-cloud-server-auth
