 ...
 */
@ApiModel("新增用户授权权限")
public class AdminUserAppFrontRequest extends DefaultCloudRequest {
    ...
    @ApiModelProperty(name = "operateAppId", position = 5, required = true, dataType = "Long", value = "操作应用IP")
    ...
    public String toString() {
        return "AdminUserAppFrontRequest{" +
                "appIdList=" + appIdList +
                ", userId=" + userId +
                ", warrant='" + warrant + '\'' +
